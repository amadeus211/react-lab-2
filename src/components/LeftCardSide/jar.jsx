...
const Jar = () =>{
    return(
        <div className="relative text-center">
            ...
            <img className="h-[203px] w-[155px] absolute left-[30px] top-[10px]" src="https://send.monobank.ua/img/jar/uah_33.png" alt="jar glass" />
            <div className="grid-container absolute w-[155px] h-[203px] top-[39px] left-[45px]">
                ...
                <div className="jar-label jar-goal absolute bottom-[190px] left-[13px] font-[800] text-[10px] text-red">900&nbsp;000</div>
                <div className="jar-label jar-middle absolute bottom-[116px] left-[5px] font-[800] text-[10px] text-red">450&nbsp;000</div>
